    ...
    <section className="lg:px-12 px-4 py-4 space-y-20">
      <div className="flex flex-col justify-center gap-2 min-h-[80vh]">
        <h1 className="font-black lg:text-7xl text-5xl font-mono lg:w-[80%] flex flex-col">
          <span className="bg-clip-text dark:text-transparent bg-gradient-to-b from-foreground to-muted">
            Create and mint
          </span>
          <span className="bg-clip-text dark:text-transparent bg-gradient-to-b from-foreground to-muted">
            your favorite NFTs
        ...
        <Link href={"/art"} className={buttonVariants({className: "mt-4 w-fit"})}>
          <Send /> Explore
        </Link>
      </div>
    </section>
